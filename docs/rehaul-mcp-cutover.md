...
The larger dashboard tabs/log redesign, client-origin log refinements and dashboard project-open feature remain unimplemented. They are not authorized or claimed complete by this cutover. The historical handoff and per-reader check snapshots retain their original publication-hold evidence.
